...
namespace TurboHTTP.Tests.Transport.Http2
{
    ...
    {
        [Test]
        public async Task DataFrame_RoundTrip()
        {
        ...
        [Test]
        public async Task HeadersFrame_RoundTrip()
        {
            await AssertFrameRoundTrip(new Http2Frame
            {
        ...
        [Test]
        public async Task SettingsFrame_RoundTrip()
        {
        ...
        [Test]
        public async Task PingFrame_RoundTrip()
        {
        ...
        [Test]
        public async Task GoAwayFrame_RoundTrip()
        {
        ...
        [Test]
        public async Task WindowUpdateFrame_RoundTrip()
        {
        ...
        [Test]
        public async Task RstStreamFrame_RoundTrip()
        {
        ...
        [Test]
        public async Task ContinuationFrame_RoundTrip()
        {
            await AssertFrameRoundTrip(new Http2Frame
            {
        ...
        [Test]
        public async Task StreamId_31BitMasking_HighBitCleared()
        {
        ...
        [Test]
        public async Task StreamId_Zero_ConnectionLevel()
        {
            await AssertFrameRoundTrip(new Http2Frame
            {
                Type = Http2FrameType.Settings,
        ...
        [Test]
        public async Task ZeroPayload_EmptyArray()
        {
            var ms = new MemoryStream();
            var codec = new Http2FrameCodec(ms);
        ...
        [Test]
        public async Task FrameSizeValidation_RejectsOversized()
        {
            var ms = new MemoryStream();
            ...
            var codec = new Http2FrameCodec(ms);
            Assert.ThrowsAsync<Http2ProtocolException>(
                () => codec.ReadFrameAsync(Http2Constants.DefaultMaxFrameSize, CancellationToken.None));
        }

        [Test]
        public async Task WritePrefaceAsync_Correct24Bytes()
        {
            var ms = new MemoryStream();
            var codec = new Http2FrameCodec(ms);
