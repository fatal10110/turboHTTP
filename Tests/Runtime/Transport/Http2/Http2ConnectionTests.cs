...
namespace TurboHTTP.Tests.Transport.Http2
{
    ...
    public class Http2ConnectionTests
    {
        ...
        [Test]
        public async Task InitializeAsync_SendsPreface()
        {
            var duplex = new TestDuplexStream();
        ...
        [Test]
        public async Task InitializeAsync_SendsSettings()
        {
            var duplex = new TestDuplexStream();
            var conn = new Http2Connection(duplex.ClientStream, "test.example.com", 443);
            var initTask = conn.InitializeAsync(CancellationToken.None);
        ...
        [Test]
        public async Task InitializeAsync_AcksServerSettings()
        {
            var duplex = new TestDuplexStream();
            var conn = new Http2Connection(duplex.ClientStream, "test.example.com", 443);
            var initTask = conn.InitializeAsync(CancellationToken.None);
        ...
        [Test]
        public async Task SendGetRequest_ReceiveResponse()
        {
        ...
        [Test]
        public async Task SendPostRequest_WithBody()
        {
            using var cts = new CancellationTokenSource(10000);
            var (conn, serverStream, duplex) = await CreateInitializedConnectionAsync(cts.Token);
            var serverCodec = new Http2FrameCodec(serverStream);
        ...
        [Test]
        public async Task SendRequest_AfterGoaway_Throws()
        {
            using var cts = new CancellationTokenSource(10000);
            var (conn, serverStream, duplex) = await CreateInitializedConnectionAsync(cts.Token);
            var serverCodec = new Http2FrameCodec(serverStream);
        ...
        [Test]
        public async Task PingFrame_EchoedWithAck()
        {
            using var cts = new CancellationTokenSource(10000);
            var (conn, serverStream, duplex) = await CreateInitializedConnectionAsync(cts.Token);
            var serverCodec = new Http2FrameCodec(serverStream);
        ...
        [Test]
        public async Task GoAwayFrame_FailsHigherStreams()
        {
            using var cts = new CancellationTokenSource(10000);
            var (conn, serverStream, duplex) = await CreateInitializedConnectionAsync(cts.Token);
            var serverCodec = new Http2FrameCodec(serverStream);
            ...
            Assert.ThrowsAsync<UHttpException>(async () => await task2);
        ...
        [Test]
        public async Task RstStreamFrame_FailsSpecificStream()
        {
            using var cts = new CancellationTokenSource(10000);
            var (conn, serverStream, duplex) = await CreateInitializedConnectionAsync(cts.Token);
            var serverCodec = new Http2FrameCodec(serverStream);
            ...
            Assert.ThrowsAsync<UHttpException>(async () => await responseTask);

            conn.Dispose();
        }

        [Test]
        public async Task PushPromise_RejectedWithRstStream()
        {
            using var cts = new CancellationTokenSource(10000);
            var (conn, serverStream, duplex) = await CreateInitializedConnectionAsync(cts.Token);
            var serverCodec = new Http2FrameCodec(serverStream);
        ...
        [Test]
        public async Task Settings_UnknownId_Ignored()
        {
            using var cts = new CancellationTokenSource(10000);
            var (conn, serverStream, duplex) = await CreateInitializedConnectionAsync(cts.Token);
            var serverCodec = new Http2FrameCodec(serverStream);
        ...
        [Test]
        public async Task SettingsAck_NonZeroPayload_FrameSizeError()
        {
        ...
        [Test]
        public async Task ContinuationFrame_WrongStream_ConnectionDies()
        {
        ...
        [Test]
        public async Task NonContinuation_WhileExpectingContinuation_ConnectionDies()
        {
        ...
        [Test]
        public async Task DataFrame_PaddingLengthExceedsPayload_ConnectionDies()
        {
        ...
        [Test]
        public async Task ContinuationFrame_WithEndStreamOnHeaders_CompletesStream()
        {
        ...
        [Test]
        public async Task Dispose_FailsAllActiveStreams()
        {
            using var cts = new CancellationTokenSource(10000);
            var (conn, serverStream, duplex) = await CreateInitializedConnectionAsync(cts.Token);
            var serverCodec = new Http2FrameCodec(serverStream);
        ...
        [Test]
        public async Task Dispose_SendsBestEffortGoaway()
        {
            using var cts = new CancellationTokenSource(10000);
            var (conn, serverStream, duplex) = await CreateInitializedConnectionAsync(cts.Token);
            var serverCodec = new Http2FrameCodec(serverStream);
        ...
        [Test]
        public async Task StreamIdExhaustion_ThrowsOnOverflow()
        {
        ...
        [Test]
        public async Task PostRequest_StreamStateIsOpen_ThenHalfClosedLocal()
        {
        ...
        [Test]
        public async Task Settings_HeaderTableSizeBackToDefault_UpdatesEncoder()
        {
        ...
        [Test]
        public async Task SettingsAck_OnNonZeroStream_ProtocolError()
        {
        ...
        [Test]
        public async Task TeHeader_OnlyTrailersAllowed()
        {
        ...
        [Test]
        public async Task TeHeader_TrailersValueAllowed()
        {
        ...
        [Test]
        public async Task MissingStatus_FailsStream()
        {
        ...
        [Test]
        public async Task InvalidStatus_FailsStream()
        {
        ...
        [Test]
        public async Task HpackDecodingError_SendsGoAwayCompressionError()
        {
