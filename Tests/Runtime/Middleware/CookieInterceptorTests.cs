...
{
    [TestFixture]
    public class CookieInterceptorTests
    {
        [Test]
        public void CookieInterceptor_AttachesMatchingCookies()
        {
            Task.Run(async () =>
            {
                int callCount = 0;
                ...
                var middleware = new CookieInterceptor(new CookieJar());
        ...
        [Test]
        public void CookieInterceptor_ExcludesDomainAndPathMismatches()
        {
            Task.Run(async () =>
            {
                int callCount = 0;
        ...
        [Test]
        public void CookieInterceptor_DoesNotSendExpiredCookies()
        {
            Task.Run(async () =>
            {
                int callCount = 0;
        ...
        [Test]
        public void CookieInterceptor_HonorsSecureAttribute()
        {
            Task.Run(async () =>
            {
                int callCount = 0;
        ...
        [Test]
        public void CookieInterceptor_RespectsSameSiteForCrossSiteRequests()
        {
            Task.Run(async () =>
            {
                int callCount = 0;
        ...
        [Test]
        public void CookieInterceptor_DoesNotDuplicateCookieNamesWhenMergingExistingHeader()
        {
            Task.Run(async () =>
            {
                int callCount = 0;
        ...
        [Test]
        public void CookieInterceptor_ImplementsIDisposable()
        {
            Assert.IsTrue(new CookieInterceptor() is IDisposable);
        }
    }
}
